import{g as l,r as i,k as f,f as u,t as C,a as y,l as b,b as M,s as P,p as k}from"./firebace-Cb3kG9CG.js";import{d as I,c as U,l as H,r as B,i as D,a as F,b as N,v as S}from"./redirect-B0htx7i8.js";import{r as J,p as j,v as q,a as z}from"./payments-CSfKEeEX.js";import{a as E,g as O,d as L,e as x}from"./requests-CicnuAer.js";import"./index-yFKSUj0c.js";import"./just-validate.es-C73wyOde.js";import"./add-reg-user-DPrUt8dX.js";const G=JSON.parse(localStorage.getItem("user")||"[]");async function A(e,a,o,n){const t=l(".users__content"),d=[];if(!t)return;e.forEach(r=>{const c={id:r.id,img:r.img,name:r.name,surname:r.surname,allCollections:r.myProds.length,succsesfulCollections:0,dateOfRegister:r.dateOfRegister,role:r.role,allProducts:r.myProds};r.myProds.forEach(_=>{a.forEach(m=>{m.id===_&&m.status&&c.succsesfulCollections++})}),c.id!==G.id&&d.push(c)}),d.sort((r,c)=>R(c.dateOfRegister).getTime()-R(r.dateOfRegister).getTime()).forEach(r=>{K(r,t,o,n)})}function R(e){const[a,o,n]=e.split(".").map(Number);return new Date(n,o-1,a)}function K(e,a,o,n){const t=i("div",["user-card",`user-card_${e.id}`]),d=i("a",["user",`user_${e.id}`]);d.href=`user.html?id=${e.id}`;const s=i("div","user__img");s.innerHTML=`
